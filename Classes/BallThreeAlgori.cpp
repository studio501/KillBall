        ...
        for (auto j=0; j<6; j++) {
            if(m_arrBall[j][i].ballColor==BALLNULL){
                ...
                while (true) {
                    temp_rowBall.clear();
                    temp_colBall.clear();
                    if (j-1>=0 and m_arrBall[j-1][i].ballColor!=BALLNULL) {
                        if (j-2>=0 and m_arrBall[j-2][i].ballColor!=BALLNULL) {
                    ...
                    if (i-1>=0 and m_arrBall[j][i-1].ballColor!=BALLNULL) {
                        if (i-2>=0 and m_arrBall[j][i-2].ballColor!=BALLNULL) {
